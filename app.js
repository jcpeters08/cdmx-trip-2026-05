...
const DEEP_DIVES = {
  ...
  "roma-norte": {
    ...
    food: [
      { name: "Cardinal Casa de Café", cat: "coffee", why: "Mexican single-origins from Oaxaca, Veracruz, Chiapas. Pour-over, Aeropress, Chemex — baristas walk you through method choice. In-house roasted beans for sale.", addr: "Roma Norte" },
      { name: "Buna", cat: "coffee", why: "Minimalist roastery that supplies Michelin-starred Quintonil and Rosetta. Single-origin focus, ecologically sourced. The fastest path to understanding why CDMX coffee is having a moment.", addr: "Roma Norte" },
      { name: "Qūentin Café", cat: "coffee", why: "Two Roma Norte locations. Flat whites are widely cited as the best in the neighborhood. Pastry program is no slouch either — sit-in or grab-and-go.", addr: "Roma Norte" },
      { name: "Café Nin", cat: "coffee", why: "Panadería Rosetta's pastries without the line. Add chilaquiles, huevos rancheros, breakfast cocktails. Stylish, lingering-friendly. Sister concept to Rosetta from chef Elena Reygadas.", addr: "Roma Norte" },
      ...
      { name: "Contramar", cat: "dinner", why: "Lunch only, but the lunch is legendary. Tuna tostadas + the whole-fish red-and-green sauce are the canonical orders. Sprawling all-out dining room — book ahead.", addr: "Calle de Durango, Roma Norte" },
      { name: "Páramo", cat: "dinner", why: "Tacos in a more atmospheric setting than a street cart — wide range from meaty to vegan, killer drinks program, no reservations. Drink at the bar while you wait.", addr: "Roma Norte" },
      { name: "Taquería Orinoco", cat: "street", why: "Monterrey-style tacos: trompo (al pastor), arrachera (steak), chicharrón. The 'pirata' (grilled steak quesadilla) is a must. Two Roma Norte locations — Álvaro Obregón has the longest lines, Yucatán is faster.", addr: "Two Roma Norte locations · Álvaro Obregón + Yucatán" },
      { name: "El Hidalguense", cat: "street", why: "Barbacoa de borrego (lamb) cooked traditionally in agave leaves. Featured on Netflix's Taco Chronicles. Open Fri–Sun ONLY. Worth planning around — locals drive across the city for this.", addr: "Roma Sur (~10 min walk south)" },
